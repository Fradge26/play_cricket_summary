...
class PlayCricketMatchSummary:
    ...
    def sync_summaries(self, new_summaries):
        ...
        for path in new_summaries:
            ...
            try:
                ...
                self.logger.info(f"{os.path.join(self.jpg_temp_path, basename)}, {os.path.join(self.jpg_sent_path, basename)}")
    ...
    def get_result_data(self, match_id):
        ...
        summary_data = {
            ...
            "innings_1_team": self.get_team_name(match_details["innings"][0]["team_batting_name"].upper()),
            ...
            "innings_2_team": self.get_team_name(match_details["innings"][1]["team_batting_name"].upper()),
